				...
				switch ($table_name) {
					...
					case 'm_sales_regions':
						...
						foreach ($array as $item) {
							...
							$model_1 = new Mysql($this->host, $this->user, $this->password, $this->db_1);
							$country_model = $model_1->where('country', $country_name)->get('country_code');
							...
							echo $current_population2022.'<br>';
							echo $current_population2021.'<br>';
							echo $current_population2020.'<br>';
							echo $current_population2019.'<br>';
...
//							$json_api = $this->get_Sales_region_Api(68, $country_code, $r_state, $r_cluster_1);
                            ...
                            $population_json = array(
                                "current_population2022" => $current_population2022,
                                "current_population2021" => $current_population2021,
                                "current_population2020" => $current_population2020,
                                "current_population2019" => $current_population2019,
                                "employment" => $employment,
                                "unemployementrate" => $unemployment,
                                "dgp_dlflator" => $gdp_deflator,
                                "gni_deflator" => $gni_deflator,
